...
export default function EnlacesInteresPage() {
  return (
    <Container className="text-start p-3">
      <p>
        Enlaces en los cuales podrán encontrar información de interés, bases de
        datos, portales, postulación a becas nacionales e internacionales, entre
        otros.
      </p>
      <p className="fw-bold fs-5">Enlaces de magazines sobre ciencias</p>
      ...
      <br />
      <a href="https://www.pourlascience.fr/">https://www.pourlascience.fr/</a>
      <br />
      <a href="https://images.math.cnrs.fr/">https://images.math.cnrs.fr/</a>
      <br />
      <a href="https://zbmath.org/">https://zbmath.org/</a>

      <p className="fw-bold fs-5 mt-2">Enlaces de instituciones</p>
      ...
      <p className="fw-bold fs-5 mt-2">Enlaces para cursos</p>
      ...
      <p className="fw-bold fs-5 mt-2">Enlaces a competiciones</p>
      ...
      <p className="fw-bold fs-5 mt-2">Otros</p>
      ...
      <br />
      <a href="https://www.gob.pe/prociencia">https://www.gob.pe/prociencia</a>
      <br />
