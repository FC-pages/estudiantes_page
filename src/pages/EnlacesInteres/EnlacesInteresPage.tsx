        ...
        <Tab eventKey="Revistas sobre ciencias" title="Revistas sobre ciencias">
          <Container className="p-3">
            <p className="fs-4 fw-bold">
              1. <a href="https://www.larecherche.fr/">La Recherche</a>
            </p>
            <p>
              La Recherche is a monthly French language popular science magazine
              covering recent scientific news. It is published by the Société
              d'éditions scientifiques, a subsidiary of Financière Tallandier.
              Tallandier is owned by Artémis, an investment company of
              François-Henri Pinault. The headquarters is in Paris.
            </p>
            <img
              style={{ backgroundColor: "#126f91", height: "70px" }}
              alt="La Recherche"
              src="./logo_lr.png"
            />
            ...
            <p>
              Toute l'actualité scientifique est sur sciencesetavenir.fr :
              sciences naturelles, sciences humaines, environnement,
              archéologie, exploration spatiale...
            </p>
            <img
              style={{ backgroundColor: "#126f91", height: "70px" }}
            ...
            <p className="mt-3 fs-4 fw-bold">
              6. <a href="https://zbmath.org/">https://zbmath.org/</a>
            </p>
          </Container>
        </Tab>
        <Tab
