...
import data2023_1 from "../../../../data/2023_1/ayudantias.json";
		...
		<Container>
			<div className="mb-2">
				...
				<a
					target="_blank"
					rel="noreferrer"
					href="https://forms.gle/QqWY77726kZMkm91A"
					type="button"
					className={`btn btn-warning btn-lg cancelar-insc ${
						divsVisibility[0] ? "" : "d-none"
					}`}
				>
					Cancelar ayudantía
