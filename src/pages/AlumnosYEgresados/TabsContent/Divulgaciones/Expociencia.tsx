    ...
    <Container>
        <Row>
          <div className = "cont-tab">
            ...
            <p>Esta actividad se llevará a cabo el viernes 25 de noviembre del 2022 organizada por 
            la Escuela Profesional de Matemática, Facultad de Ciencias, UNI, con la
             finalidad de difundir la carrera a través de trabajos aplicados propuestos por los alumnos, profesores,
...
sus cinco escuelas y tiene como finalidad difundir a los alumnos, básicamente de colegios, trabajos experimentales y otros, 
  realizados por los profesores, egresados, alumnos e invitados de la Facultad de Ciencias.*/}</p>
            ...
            <div className='vineta'>
              <ul>
                <li>
                  ...
                  <a className="a-link" href="https://forms.gle/tSxQbJTJfnKH5Aqa9">              
                    <FaPaperclip size={20} />
                  </a>
                </li>
                {/*<li>
            ...
            <ol>
              <li>Simulación de la propagación del cáncer usando "el juego de la vida"</li>
              <li>Técnica Bayesiana: clasificación de textos</li>
              <li>Diferencias Finitas para un modelo de combustión in situ</li>
              <li>Modelo matemático epidemiológico SIRS</li>
              <li>Runge-Kutta orientado a la degeneración de órbitas de satélites</li>
              <li>Proceso de inmunización contra la Covid-19</li>
              <li>Cuaterniones para la eliminación de Gimbal Lock</li>
              <li>Ecuación de Bessel para modelar la vibración de una membrana</li>
              ...
              <li>Teoría de grafos y medidas de tendencia central para "generar mi agenda"</li>
            </ol>
            <h5 className="t-stroke-shadow-h5">Charlas divulgativas</h5>
            <ol>
              <li>David Morante. Técnicas de descomposición aplicadas en el despacho de energía</li>
              <li>Daniel Gutierrez. Matemática para la Ciencia de Datos</li>
              <li>José Cerda. Una aplicación al estudio de la anemia en el Perú</li>
              ...
              <li>Angel Ramirez. Descomposición de valores singulares en comprensión de imágenes</li>
            </ol>
