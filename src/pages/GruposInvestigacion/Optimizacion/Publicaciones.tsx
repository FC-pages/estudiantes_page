  ...
  return (
    <Fragment>
      ...
      <div className="container">
        ...
        <img src={pub1} className="foto-profesor"></img>
        </div>
      </div>
      <br/>
      <hr className="dotted"></hr>
      <h4 className="tit">Bayesian skew-probit regression for binary response data</h4>
      <div className="container">
        <div className="itemLeft2">
        ...
        <div className="itemRight2">
        <img src={pub3} className="foto-profesor"></img>
        </div>
      </div>
      <br/>
      <hr className="dotted"></hr>
      ...
      <div className="container">
        ...
        <div className="itemRight2">
        <img src={pubb} className="foto-profesor"></img>
        </div>
      </div>
      <br/>
      <hr className="dotted"></hr>
      ...
      <div className="container">
        ...
        <div className="itemRight2">
        <img src={pub4} className="foto-profesor"></img>
        </div>
      </div>
      <br/>
      <hr className="dotted"></hr>
      ...
      <div className="container">
        ...
        <div className="itemRight2">
        <img src={pub5} className="foto-profesor"></img>
        </div>
      </div>
      <br/>
      <hr className="dotted"></hr>
