...
import { alg_geome_topologia } from "../../../data/publicaciones.js";
...
const TabFour: FC<{}> = () => {
  return (
    <Fragment>
      ...
      */}
      {
        alg_geome_topologia.map((publicacion) => {
          return <Publicacion
            pub = {publicacion}
            />
        })
