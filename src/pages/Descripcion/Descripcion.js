                    ...
                    <article id="tab2">
                        <table className="App-resena" cellSpacing={0} cellPadding={5}>
                            <tr>
                                <td>
                                    <b className="anios">1960</b>
                                    <p> Se creó la Facultad de Ciencias Físicas y Matemáticas en la Universidad Nacional de Ingeniería con las carreras de Física Química y Matemática, a partir de la entonces Facultad de Ciencias Básicas y Nucleares.</p>
                                </td>
                                <td> </td>
                            </tr>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td className="App-profes-td">
                                        <ul>
                                            ...
                                            <li>Trayectoria como docente en educación superior a partir del año 2010. <a href="http://dina.concytec.gob.pe/appDirectorioCTI/VerDatosInvestigador.do?id_investigador=27285">CVM</a> </li>
                                        </ul>
                                    </td>
                                </tr>
                            </table> 
